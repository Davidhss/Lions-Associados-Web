...
$leadsTotais = count(consultarLeadsAtribuidas($id_funcionario));
...
if (isset($_GET['pesquisa'])) {
    ...
    $leads = pesquisaLeadsAtribuidas($campo_tipo, $campo_pesquisa, $id_funcionario);
} else {
    $leads = consultarLeadsAtribuidas($id_funcionario, $inicio, $total_registros);
}

$quantidadeLeads = count($leads);
    ...
    <div class="meio">
        <div class="titulo supervisor">
            ...
            <div class="botoes_head">
                ...
                <div class="filtragem">
                    <?php include("../components/normal/botoesFiltros.php"); ?>
                </div>
            </div>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td data-label="Atribuicao">
                        ...
                        if ($lead['cod_funcionario'] == NULL) { ?>
                            <span class='naoAtribuido'> Não atribuído </span>
                        <?php
                        } else { ?>
                            <span>
