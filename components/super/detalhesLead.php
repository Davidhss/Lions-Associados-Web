<!-- <div class="agenda" id="agenda">
    <form action="" id="modal-agenda" method="post">
        <i class="fa-solid fa-x" onclick="modalAgenda()"></i>
        <h3>Detalhes da Agenda</h3>
...
<main id="lead">
    <div class="Lead">
        <?php include "../components/formAgendamento.php"; ?>
        <div class="headLead">
            <div class="info_controle">
                ...
                <div class="acoes">
                    ...
                    <a href="javascript:confirmarExclusao();" class="excluir">
                        <div class="icone_cabecalho"><i class="fa-solid fa-trash"></i></div>
            ...
            <div class="origem">
                <div class="quadro">
                    <div class="info_origem">
                        <?php
                        include("../components/origemLead.php");
                        ?>
